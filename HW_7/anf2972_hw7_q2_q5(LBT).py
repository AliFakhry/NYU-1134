    ...
    def leaves_list(self):
        ...
        def gen_leaves(root):
            ...
            if root.left != None and root.right != None:
                ...
                yield from gen_leaves(root.left)

                yield from gen_leaves(root.right)
        ...
        if self.root == None:
            ...
            return [val.data for val in gen_leaves(self.root)]
    ...
    def iterative_inorder(self):
        ...
        while curr_node != None:
            ...
            if curr_node.left == None:
                ...
                new_switch = curr_node.left

                while (new_switch.right != curr_node and new_switch.right != None):

                    new_switch = new_switch.right

                if new_switch.right == None:

                    new_switch.right = curr_node

                    curr_node = curr_node.left

                else:

                    new_switch.right = None
